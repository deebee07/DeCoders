...
cursor.execute('CREATE TABLE studentMaster (studentId INTEGER UNIQUE, studentName CHAR(20),classId INTEGER, ImeiNum CHAR(20) DEFAULT NULL)')


cursor.execute('CREATE TABLE attendCmpe273 (studentId INTEGER, present CHAR(2), dateValue CHAR(10),time DEFAULT NULL, PRIMARY KEY (studentId,dateValue))')

cursor.execute('CREATE TABLE classToken (classId INTEGER UNIQUE, token INTEGER UNIQUE, tableName CHAR(20))')


for t in [(1,'CMPE273','Mr. Sithu Aung',7,'xxxxxxxxxxxxxxxx0'),(2,'CMPE277','Mr. Chandrasekar Vuppalapati',10,'xxxxxxxxxxxxxxxx1'),(3,'CMPE283','Mr. Mike Larkin',14,'xxxxxxxxxxxxxxxx2')]:
